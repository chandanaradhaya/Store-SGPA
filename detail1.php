...
$con = mysqli_connect('localhost', 'root', '','db1_table');
...
if($rs)
{
    echo ' <br><span style="font-size: 30px; font-style:italic;"> <b>RECORDS INSERTED....!!<br> <br>To Download PDF, Kindly Go To Previous Page </span></b>';
}
?>